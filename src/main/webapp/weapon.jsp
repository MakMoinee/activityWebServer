                ...
                <body>
                                ...
                                <div class="col-12">
                                    <nav class="main-nav">
                                        ...
                                        <ul class="nav">
                                            ...
                                            <li class="scroll-to-section"><a
                                                    href="<%=
                                                    Common.hostName %>/weapons.jsp"
                                                    class="active">Weapons</a></li>
                                            <li class="scroll-to-section"><a
                                                    href="#login"
                                                    data-toggle="modal"
                    ...
                    <div class="welcome-area" id="welcome"
                        ...
                        <div class="header-text">
                            <div class="container">
                                <div class="row">
                                    <div class="left-text col-lg-6 col-md-6
                                        col-sm-12
                                        col-xs-12"
                                        data-scroll-reveal="enter left move 30px
                                        over
                                        0.6s after 0.4s">
                                        <h1>
                                            Valorant InfoSys is free <strong>for
                                                YOU</strong>
                                        </h1>
                                        <h2>
                                            By: <b>Jenneth Canlas</b>
                                        </h2>
                                        <p>Create an account and free to use
                                            nice and
                                            exciting contents from
                                            valorant</p>
                                        <a href="#about"
                                            class="main-button-slider">Find
                                            Out More</a>
                                    </div>
