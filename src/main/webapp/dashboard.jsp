                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-12">
                                <nav class="main-nav">
                                    <!-- ***** Logo Start ***** -->
                                    <a href="#" class="logo" style="font-family:
                                        'Valorant';color:#FFFFFF !important;">Valorant
                                        InfoSys</a>
                                    <!-- ***** Logo End ***** -->
                                    <!-- ***** Menu Start ***** -->
                                    <ul class="nav">
                                        <li class="scroll-to-section"><a
                                                ...
                                                class="active"
                                                style="color:#FFFFFF
                                                !important;">Dashboard</a></li>
                                        <li class="scroll-to-section"><a
                                                href="#about">About</a></li>
                                        <li class="scroll-to-section"><a href="<%=
                                                Common.hostName %>/weapon.jsp">Weapons</a></li>
                                        <li class="scroll-to-section"><a
                                                href="#login"
                                                data-toggle="modal"
                                ...
                                <div class="card mb-12">
                                    <div class="card-header">
                                        <button class="btn btn-primary"
                                            ...
                                            style="background-color: #e80032;
                                            font-family: 'Valorant';">Add
                                            User</button>
                                    </div>
                                    <!-- <div class="card-header">
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-lg-7 col-md-12 col-sm-12">
                                <p class="copyright">
                                    Copyright &copy; 2023 Valorant InfoSys
                                    Company
                                </p>
                            </div>
                ...
                <div class="modal fade " id="loginModal" tabindex="-1"
                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <div class="row">
                                    <form action="<%= Common.hostName %>/login"
                                        method="POST"
                                ...
                                <div class="modal-footer">
                                    <button style="font-family:
                                        'Valorant';" type="button" class="btn
                                        btn-secondary"
                                        data-dismiss="modal">Close</button>
                                    <button style="font-family:
                                        'Valorant'; background-color:
                                        #e80032" type="submit" class="btn
                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            <form action="<%= Common.hostName %>/logout" method="GET">
                                <div class="modal-body">
                                    <h5 class="modal-title"
                                        id="logOutModalLabel">Do you want to
                                        proceed logging out ?</h5>
                                </div>
                                <div class="modal-footer">
                                    <button type="submit" class="btn
                                        btn-primary">Yes, Proceed</button>
